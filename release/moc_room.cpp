...
QT_MOC_LITERAL(1, 5, 7), // "newRoom"
QT_MOC_LITERAL(2, 13, 0), // ""
QT_MOC_LITERAL(3, 14, 17), // "on_Back_1_clicked"
QT_MOC_LITERAL(4, 32, 17) // "on_Next_1_clicked"

    },
    "Room\0newRoom\0\0on_Back_1_clicked\0"
    "on_Next_1_clicked"
};
...
void Room::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newRoom(); break;
        case 1: _t->on_Back_1_clicked(); break;
        case 2: _t->on_Next_1_clicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (Room::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Room::newRoom)) {
                *result = 0;
                return;
            }
        }
